...
import {
  deleteRecord, getAllSiteContent, getContactCtas, getEvents, getGallery, getMemberCategories, getMembers,
  getSocialLinks, getVideos, isSlugAvailable, queryKeys, saveRecord,
} from '../../services/content'
import { generateSlug, withSlugSuffix } from '../../utils/slug'
import { extractYouTubeVideoId } from '../../utils/youtube'

type Kind = 'members' | 'categories' | 'events' | 'videos' | 'gallery' | 'homepage' | 'social' | 'contacts' | 'settings'
